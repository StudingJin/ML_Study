...
class ModelMgr():
    ...
    def get_hyperparameter(self):
        ...
        #######################
        hyper = dict()
        hyper['batch_size'] = 16  ## 배치 사이즈 설정하는 부분 입니다.
        hyper['epochs'] = 10  ## 에폭을 설정하는 부분 입니다.

        hyper['learning_rate'] = 0.1  ## 학습률을 설정하는 부분입니다.
        hyper['optimizer'] = keras.optimizers.SGD(learning_rate=hyper['learning_rate'])  ## default: SGD
